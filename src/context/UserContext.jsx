...
import { fetchUsers, createUser as apiCreateUser, updateUser as apiUpdateUser, deleteUser as apiDeleteUser } from '../services/apiService';
...
export const UserProvider = ({ children }) => {
  ...
  const [searchTerm, setSearchTerm] = useState(''); // Add separate searchTerm
  ...
  const setFiltersHandler = (newFilters) => {
